...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Waow.GG v2`}</title>

        <meta
          name="description"
          content="Experience the thrill of gaming with Waow.GG v2, your ultimate destination for game matches and betting. Elevate your gaming, challenge your skills, place your bets, and win big!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1657664072470-99b02c2143f2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxnYW1pbmd8ZW58MHx8fHwxNjk2ODQ0NzU2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the thrill of gaming with Waow.GG v2, your ultimate destination for game matches and betting. Elevate your gaming, challenge your skills, place your bets, and win big!`}
            </Text>
            <Box
