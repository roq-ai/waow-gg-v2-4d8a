...
import { getMatchResultById } from 'apiSdk/match-results';
import { MatchResultInterface } from 'interfaces/match-result';

function MatchResultViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('match_result', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/match-results/edit/${id}`} passHref legacyBehavior>
                    <Button
