...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order Placed.create': { roles: ['administrator'], key: 'order_placed', tenantPath: [], userPath: [] },
  'Payment Received.update': { roles: ['administrator'], key: 'payment_received', tenantPath: [], userPath: [] },
...
const tenantRoles: string[] = ['administrator', 'customer'];
